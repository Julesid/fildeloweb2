...
function Dashboard() {
  ...
  return (
    <div>
      ...
      <h1>
        Connecté en tant que {username} pour l'épreuve {epreuve} / promo {promotion}
      </h1>
      <ul className="menu bg-base-200 lg:menu-horizontal rounded-box fixed bottom-4 left-1/2 transform -translate-x-1/2 z-50">
        <li>
          <a>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="blue">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12h3l3-9 4 18 4-12 3 6h3" />
            </svg>
            Activités
          </a>
        </li>
